                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      controller.driverUserModel.value.walletAmount != null
                          ? Text(
                              "\$MILE ${double.parse(controller.driverUserModel.value.walletAmount.toString()).toStringAsFixed(Constant.currencyModel!.decimalDigits!)}",
